      ...
      .catch(() =>
        caches.match(event.request).then((cached) => {
          ...
          if (event.request.mode === 'navigate') {
            return new Response(
              '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Brocco</title><style>body{background:#faf6ea;color:#26301a;font-family:system-ui;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0;text-align:center}.c{max-width:300px}img{width:72px;height:72px;margin-bottom:0.75rem;border-radius:9999px;border:2px solid #26301a}p{color:#7d8468;font-size:0.875rem;font-weight:600}</style></head><body><div class="c"><img src="/icons/icon-192.png" alt=""><p id="m">You\'re offline. Check your connection and try again.</p></div><script>var m={de:"Du bist offline. Prüfe deine Verbindung und versuch es noch einmal.",es:"Estás sin conexión. Comprueba tu conexión e inténtalo de nuevo."};var l=((navigator.languages&&navigator.languages[0])||navigator.language||"").slice(0,2).toLowerCase();if(m[l]){document.getElementById("m").textContent=m[l];document.documentElement.lang=l;}</script></body></html>',
