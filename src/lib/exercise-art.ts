...
export const EXERCISE_ART: ExerciseArt[] = [
  ...
  { slug: "cow-pose", label: "Cow pose", prompt: "on hands and knees in cow pose, side view: hands under shoulders and knees under hips, belly dropped so the back arches downward, chest and head lifted looking forward" },
  { slug: "cobra-pose", label: "Cobra", prompt: "lying face down in cobra pose, side view: hips and legs on the floor, hands under the shoulders, elbows bent, chest lifted off the floor with a gentle back arch" },
  { slug: "upward-dog", label: "Upward dog", prompt: "in upward facing dog, side view: hands on the floor with arms straight, chest lifted high, hips and thighs lifted off the floor, tops of the feet on the floor" },
  { slug: "sphinx-pose", label: "Sphinx", prompt: "lying face down in sphinx pose, side view: forearms flat on the floor with elbows under the shoulders, chest lifted, hips and legs resting on the floor" },
  { slug: "low-lunge", label: "Low lunge", prompt: "in a low lunge, side view: front knee bent over the front foot, back knee resting on the floor with the shin along the floor, torso upright, arms reaching straight up overhead" },
  { slug: "high-lunge", label: "High lunge", prompt: "in a high lunge, side view: front knee bent over the front foot, back leg straight and strong with the heel lifted, torso upright, arms reaching straight up overhead" },
  { slug: "warrior-one", label: "Warrior one", prompt: "in warrior one, seen from a three quarter front view: front knee bent over the ankle, back leg straight with the back foot flat and angled, hips facing forward, arms straight up overhead with palms together" },
  { slug: "warrior-two", label: "Warrior two", prompt: "in warrior two, facing the viewer: legs wide, front knee bent over the ankle, back leg straight with the foot flat, arms extended out to both sides at shoulder height, gaze over the front hand" },
