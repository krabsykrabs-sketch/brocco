...
export function EquipmentSection() {
  ...
  return (
    <section className="sticker px-4 py-3">
      <p className="text-sm font-bold text-ink">🏋️ Equipment you have</p>
      <p className="text-[11px] text-moss font-semibold mt-0.5 mb-2">
        Brocco builds strength and rehab work around this instead of guessing. Leave it empty and it
        assumes bodyweight only.
      </p>
      ...
      <div className="flex gap-2">
        <input
          ...
          placeholder="resistance bands, 16kg kettlebell…"
      ...
      {loaded && suggestions.length > 0 && (
        <div className="mt-2.5">
          <p className="label-xs mb-1.5">Common kit</p>
